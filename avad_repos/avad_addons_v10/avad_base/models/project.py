...
class ProjectVniModel2(models.Model):
    _name="vni.model.t2"

    name = fields.Char("Nom")

class ProjectVniModelMateriel(models.Model):
    _name="modele.materiel.vni"
...
class ProjectTask(models.Model):
    ...
    iah_resid_vni = fields.Float("Fuite", required=False)
    ...
    modele_mat_vni = fields.Selection(
        [('1', 'Ventilateur VIVO 40'), 
        ('2', 'Bipap Avaps C Series'), 
        ('3', 'Legendaire'), 
        ('4', 'BiPAP Synchrony 2'),
         ('5', 'Bipap pro BiFlex '), 
         ('6', 'Ventillateur Trilogy 100'), 
         ('7', 'Ventilateur HOME 2 ')], string="Modèle",
        required=False)
    modele_mat_vni_m2o = fields.Many2one("modele.materiel.vni", string="Modèle")
    marque_mat_vni = fields.Selection([('1', 'Philips'), ('2', 'Resmed'), ('3', 'AIROX'), ('4', 'Breas')],
                                      string="Marque", required=False)
    humd_mat_vni = fields.Selection([('1', 'Oui'), ('2', 'Non')],
    ...
    modele_mas_vni = fields.Selection([('1', 'Amara View'), ('2', 'Quattro fx'), ('3', 'AirFit N20')], string="Modèle",
                                      required=False)
    modele_mas_vni_2 = fields.Many2one("vni.model.t2", string="Modèle", required=False)
    ...
    ipapmax_reg_vni = fields.Float("IPAPmax (cmH2O)", required=False)
    ...
    vol_courant_vni = fields.Float("Volume courant", required=False)
    trigger_vni = fields.Float("Trigger", required=False)
    p_mode_vni = fields.Text(string="Mode")
